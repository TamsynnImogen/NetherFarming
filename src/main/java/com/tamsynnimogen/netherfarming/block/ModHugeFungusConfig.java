...
public class ModHugeFungusConfig implements IFeatureConfig {
    ...
    public static final HugeFungusConfig BLOODBARK_FUNGUS_PLANTED = new HugeFungusConfig(Blocks.SOUL_SOIL.getDefaultState(), ModBlocks.BLOODBARK_STEM.get().getDefaultState(), ModBlocks.BLOODBARK_WART_BLOCK.get().getDefaultState(), Blocks.SHROOMLIGHT.getDefaultState(), true);
    public static final HugeFungusConfig BLOODBARK_FUNGUS;
    ...
    static {
        BLOODBARK_FUNGUS = new HugeFungusConfig(BLOODBARK_FUNGUS_PLANTED.validBaseBlock, BLOODBARK_FUNGUS_PLANTED.stemState, BLOODBARK_FUNGUS_PLANTED.hatState, BLOODBARK_FUNGUS_PLANTED.decorState, false);
    }
}
