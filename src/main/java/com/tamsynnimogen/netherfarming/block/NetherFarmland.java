...
public class NetherFarmland extends Block
{
    ...
    public NetherFarmland(Properties builder) {
        super(builder);
    ...
    public BlockState getStateForPlacement(BlockItemUseContext context) {
        return !this.getDefaultState().isValidPosition(context.getWorld(), context.getPos()) ? ModBlocks.FERTILE_SOUL_SOIL.get().getDefaultState() : super.getStateForPlacement(context);
    }
    ...
    public static void turnToDirt(BlockState state, World worldIn, BlockPos pos) {
        worldIn.setBlockState(pos, nudgeEntitiesWithNewState(state, ModBlocks.FERTILE_SOUL_SOIL.get().getDefaultState(), worldIn, pos));
    }
