...
public class ModLeavesBlock extends Block implements net.minecraftforge.common.IForgeShearable {
   ...
   public static final BooleanProperty PERSISTENT = BooleanProperty.create("persistent_leaves");
    ...
    public ModLeavesBlock(AbstractBlock.Properties properties) {
        super(properties);
        this.setDefaultState(this.stateContainer.getBaseState().with(DISTANCE, Integer.valueOf(0)).with(PERSISTENT, Boolean.valueOf(false)));
    }
    ...
    private static int getDistance(BlockState neighbor) {
        if (BlockTags.LOGS.contains(neighbor.getBlock())) {
            ...
            return neighbor.getBlock() instanceof ModLeavesBlock ? neighbor.get(DISTANCE) : maxDistance;
        }
    }
