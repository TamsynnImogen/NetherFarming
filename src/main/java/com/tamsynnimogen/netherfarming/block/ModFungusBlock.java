...
public class ModFungusBlock extends BushBlock implements IGrowable {
    ...
    public ModFungusBlock(AbstractBlock.Properties properties, Supplier<ConfiguredFeature<HugeFungusConfig, ?>> fungusFeature) {
        super(properties);
